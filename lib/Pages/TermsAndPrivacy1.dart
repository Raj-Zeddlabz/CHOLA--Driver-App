...
class _TermsAndPrivacyState extends State<TermsAndPrivacy> {
  ...
  bool atBottom = true;
    ...
    /// widget's state changes. It is responsible for setting up the initial
    /// state of the widget and adding a listener to the scroll controller.
    ///
    /// The listener checks if the scroll view is at the bottom and updates the
    /// `atBottom` state accordingly.
    ///
    ...
    return Padding(
      ...
      child: Scaffold(
          appBar: CustomAppBar(
            ...
            preferredHeight: MediaQuery.of(context).size.height * 0.09,
          ),
          //  AppBar(
          //   leading: BackButton1(),
                      ...
                      Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            SizedBox(
                              height: size.height *
                                  0.06, // Set a specific height for the InkWell
                              child: Material(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            AgreeButton(
                              ...
                              fontSize: size.shortestSide * 0.047,
                              borderRadius: 30,
                              onPressed: () {
